<template>
  <div class="main-content">
    <div class="header md:mr-8 mb-3 md:mb-8 pt-4 md:pt-14">
      <div class="md:flex justify-between items-end">
        <h3 class="text-2xl flex justify-between items-center md:block">
    ...
    <div class="flex justify-center items-center header-btns">
      <div class="bg-slider">
        <div class="slider">
          <div class="slider-content">
            <p>GIVEAWAY ALERT! JOIN OUR DISCORD!</p>
            <P>12 PM PST PRESALE 09/24</P>
            <p>GIVEAWAY ALERT! JOIN OUR DISCORD!</p>
            <P>12 PM PST PRESALE 09/24</P>
          </div>
          <div class="slider-content">
      ...
      <p class="wallet-address" v-if="userAddress">
        {{ getMiniAddress(userAddress) }}
      </p>
    </div>
    <div class="left-nav">
      <div id="leftNav">
...
.nav {
  background: url(../../assets/img/menu-line.png) right bottom no-repeat;
  /* padding-right: 85px; */
  min-height: 25px;
}
...
.nav a.router-link-exact-active {
  border-bottom: 2px solid #cc01ff;
}
...
.header-btns a {
  ...
  align-items: center;
  background: url(../../assets/img/bg-btn.png);
  background-size: 100% 100%;
  margin-left: 4px;
  flex-shrink: 0;
}
.header-btns a:hover {
  background: url(../../assets/img/bg-btn-hover.png);
  background-size: 100% 100%;
}
.left-nav {
  position: fixed;
...
.left-nav #leftNav a:hover::after,
.left-nav #leftNav a.router-link-exact-active::after {
  content: "";
  width: 6px;
  left: 4px;
  border-radius: 5px;
